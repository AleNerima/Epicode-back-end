...
using System;
using static Contribuente;

namespace EsercizioTasse
{
    class Program
    {
        static void Main()
        {
            //chiedo di inserire i dati all'utente, e li salvo nelle variabili
            ...
            Console.WriteLine($"nato il {contribuente.DataNascita:dd/MM/yyyy} ({contribuente.Genere}),"); // Utilizzo di contribuente.Genere invece di contribuente.Sesso
